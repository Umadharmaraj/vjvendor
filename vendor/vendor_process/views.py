...
def table_info(request):
    #try:
        ...
        user_info = {'vendor_id': obj.vendor_id, 'vendor_type': obj.vendor_type,'company_name': obj.company_name, 'company_locality': obj.company_locality}

        '''
        'company_state': obj.company_state, 'company_pincode': obj.company_pincode, 'company_email' = obj.company_email,
        'proprietorDirectorName' = obj.proprietorDirectorName, 'proprietorDirectorContact' = obj.proprietorDirectorContact,
        ...
        'insurance_name' = obj.insurname, 'expiry_date' = obj.expiry_date, 'updated_date' = obj.updated_date
         '''
